...
//            // Send a packet to the client with the updated recipes
//            PacketHandler.sendToAllPlayers(new UpdateAvailableRecipesPacket(blockEntity.getBlockPos(), availableRecipes));
//        }
//    }
}